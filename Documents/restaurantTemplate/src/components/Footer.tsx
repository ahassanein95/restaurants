      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            <h3 className="text-2xl font-bold mb-4">{restaurantData.name}</h3>
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-gray-300">
                ...
                <a href={`mailto:${restaurantData.contact.email}`} className="hover:text-orange-400 transition-colors duration-200">
            ...
            <div className="space-y-1">
              {Object.entries(restaurantData.hours).map(([day, hours]) => (
                <div key={day} className="flex justify-between text-sm">
                  <span className="text-gray-300">{getDayName(day)}:</span>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex space-x-6 mb-4 md:mb-0">
              ...
              <Link href="/reservations" className="text-gray-400 hover:text-white transition-colors duration-200">
                Reservations
              </Link>
